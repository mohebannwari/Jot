---
name: plan-feature
description: Create a concise technical plan for a feature, researching relevant files and breaking work into logical phases.
...
5. If it is a very big and complex feature, you can also include sub-tasks - to make the plan even more granular; then we can go through the sub-tasks one after the other to really make sure everything is implemented correctly.
...
Write the plan into an cursor/plans/<N>_PLAN.md file with the next available feature number (starting with 001)
