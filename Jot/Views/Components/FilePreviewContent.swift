...
struct FilePreviewContent: View {
  ...
  private var openInAppButton: some View {
    Button {
      ...
      // @EnvironmentObject(ThemeManager). Dark: solid neutral-800 (`SecondaryBackgroundColor`); light: static NS tint track.
      .background(
        colorScheme == .dark
          ? Color("SecondaryBackgroundColor")
          : Color(nsColor: ThemeManager.tintedSecondaryButtonBackgroundNS(isDark: false)),
