...
final class DeploymentManager: ObservableObject {
    ...
    private let logger = Logger(subsystem: "com.noty.app", category: "Deployment")
    ...
    func generateAppStoreMetadata() -> AppStoreMetadata {
        return AppStoreMetadata(
            ...
            description: """
            Noty brings the future of note-taking to your Mac with Apple's cutting-edge Liquid Glass design system.
            ...
            privacyPolicy: URL(string: "https://noty.app/privacy")!,
            supportURL: URL(string: "https://noty.app/support")!,
            marketingURL: URL(string: "https://noty.app")!
        )
    }
...
private extension DeploymentManager {
    ...
    static func generateBuildInfo() -> BuildInfo {
        ...
        return BuildInfo(
            ...
            bundleIdentifier: bundle.bundleIdentifier ?? "com.noty.app",
            buildDate: Date(),
