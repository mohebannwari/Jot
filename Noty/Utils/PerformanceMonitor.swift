...
final class PerformanceMonitor {
    ...
    // MARK: - Logging
    private let logger = Logger(subsystem: "com.noty.app", category: "PerformanceMonitor")
    private let analyticsLogger = Logger(subsystem: "com.noty.app", category: "Analytics")
