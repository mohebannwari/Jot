...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Noty",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif

#if defined(__OBJC__)

SWIFT_CLASS("_TtC4Noty13AudioRecorder")
...
@class NSCoder;
SWIFT_CLASS("_TtC4Noty16InlineNSTextView")
@interface InlineNSTextView : NSTextView
...
- (void)insertText:(id _Nonnull)string replacementRange:(NSRange)replacementRange SWIFT_AVAILABILITY(macos,introduced=10.11);
